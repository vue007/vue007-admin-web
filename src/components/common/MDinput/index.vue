<template>
    <div class="material-input__component" :class="computedClasses">
        <div :class="{iconClass:icon}">
            ...
            <input v-if="type === 'url'" type="url" class="material-input" :name="name" :placeholder="fillPlaceHolder"
            ...
            <input v-if="type === 'number'" type="number" class="material-input" :name="name"
                   ...
                   :maxlength="maxlength" :required="required" @focus="handleMdFocus" @blur="handleMdBlur"
            ...
            <input v-if="type === 'password'" type="password" class="material-input" :name="name"
                   ...
                   :required="required" @focus="handleMdFocus"
                   @blur="handleMdBlur" @input="handleModelInput">
            <input v-if="type === 'tel'" type="tel" class="material-input" :name="name" :placeholder="fillPlaceHolder"
                   v-model="currentValue"
                   :readonly="readonly" :disabled="disabled" :autoComplete="autoComplete" :required="required"
                   @focus="handleMdFocus"
                   @blur="handleMdBlur" @input="handleModelInput">
            <input v-if="type === 'text'" type="text" class="material-input" :name="name" :placeholder="fillPlaceHolder"
                   v-model="currentValue"
