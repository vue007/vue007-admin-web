<template>
    <el-dialog title="编辑Banner" :visible.sync="state.editDialog" custom-class="custom_form_dialog">
        <el-form :model="form" :rules="formRules" ref="form">
            ...
            <el-form-item v-if="form.sliderType == $global.bannerType.H5" label="标题" :label-width="formLabelWidth" prop="sliderTitle">
        ...
        <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="editSlider(form)" size="medium" :loading="state.loadingDialog">确 定</el-button>
        </div>
    </el-dialog>
</template>
