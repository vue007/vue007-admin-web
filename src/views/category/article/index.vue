<template>
    <div class="container">
                ...
                <el-col :md="20">
                    ...
                    <el-form :inline="true" :model="state.searchData"  ref="searchForm">
                        ...
                        <el-form-item label="" prop="keywords">
                            <el-input class="search-item" v-model="state.searchData.keywords" size="mini" @keyup.enter.native="getData" style="width: 200px;"
        ...
        <el-table :data="state.list" v-loading="state.loadingTable">
            ...
            <el-table-column prop="articleCount" label="文章总数" min-width="100"></el-table-column>
            <el-table-column prop="latestArticleUpdateTime" label="最新更新时间" min-width="100" :formatter="$utils.dateTimeFormat"></el-table-column>
